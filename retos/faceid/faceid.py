...
def main():
    ...
    obama_image = face_recognition.load_image_file("C:\\Users\\DAV_2004_35\\Pictures\\Camera Roll\\foto.jpg")
    obama_face_encoding = face_recognition.face_encodings(obama_image)[0]

    # Load a second sample picture and learn how to recognize it.
    biden_image = face_recognition.load_image_file("C:\\Users\\DAV_2004_35\\Pictures\\Camera Roll\\foto.jpg")
        ...
        if process_this_frame:
            ...
            for face_encoding in face_encodings:
                ...
                if matches[best_match_index]:
                    ...
                    # Aqui se pone que tiene que hacer
                    login()
                    running=False
